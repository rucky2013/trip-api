...
public class JedisUtils {
	...
	public static long setList(String key, List<String> value, int cacheSeconds) {
		...
		try {
			...
			String[] arrayList = new String[value.size()]; 
			result = jedis.rpush(key, (String[])value.toArray(arrayList));
			if (cacheSeconds != 0) {
				jedis.expire(key, cacheSeconds);
			}
	...
	public static long setSet(String key, Set<String> value, int cacheSeconds) {
		...
		try {
			...
			String[] arraySet = new String[value.size()];
			result = jedis.sadd(key, (String[])value.toArray(arraySet));
			if (cacheSeconds != 0) {
				jedis.expire(key, cacheSeconds);
			}
